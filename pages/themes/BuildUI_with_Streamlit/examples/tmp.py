...
with st.sidebar:
    ...
    # Create a placeholder to update it later in the script
    emotion_placeholder = st.empty() 
    emotion_placeholder.metric("Detected Emotion", st.session_state.current_emotion.upper())
...
if user_input := st.chat_input("How are you feeling?"):
    ...
    # Update the sidebar state AND the UI placeholder immediately
    st.session_state.current_emotion = emotion_label 
    emotion_placeholder.metric("Detected Emotion", emotion_label.upper())
